...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit(f) {
            ...
            if (userIdCheck !== "N") {
                alert("아이디 중복 체크 및 중복되지 않는 아이디로 가입 바랍니다.");
                f.userId.focus();
                return;
            }
        ...
        <div class="divTableBody">
            <div class="divTableRow">
                ...
                <div class = "divTableCell">
                    <input type="text" id="userId" name="userId" style="width:80%" placeholder="아이디"/>
                ...
                <div class="divTableRow">
                    ...
                    <div class="divTableCell">
                        <input type="password" name="password" style="sidth:95%" placeholder="비밀번호"/>
                    </div>
                </div>
