...
public class UserInfoController {
    ...
    public String userRegForm() {
        ...
        public UserInfoDTO getUserExists(HttpServletRequest request) throws Exception {
            ...
            log.info("}.getUsedrIdExists End!", this.getClass().getName());
            ...
            public UserInfoDTO getEmailExists(HttpServletRequest request)throws Exception {
                ...
                log.info("{}.getEmailExists!", this.getClass().getName());
    ...
    public String login() {
        ...
        public String loginSuccess() {
            ...
            public String searchPassword(HttpSession session) {
                ...
                session.removeAttribute("NEW_PASSWOR");
            ...
            public String searchPasswordProc(HttpServletRequest request, ModelMap model, HttpSession session) throws Exception {
                log.info("{}.seearchPasswordProc Start!", this.getClass().getName());
                ...
                session.setAttribute("NEW_PASSWPRD", userId);
