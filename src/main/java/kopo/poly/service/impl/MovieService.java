...
public class MovieService implements IMovieService {
    ...
    public int collectMovieRank() throws Exception {
        ...
        log.info("{}.collecMovieRank Start!", this.getClass().getName());
...
//        Iterator<Element> open_day = element.select("span.txt_info").iterator();
...
//            pDTO.setMovieRank(rank.substring(3, rank.length(3)));
